      ...
      if (ret.status) {
          ...
          api.ajax({
              ...
              if (ret) {
                  api.setPrefs({
                      key: 'city',
                      value: ret.result.addressComponent.city
                  });
              } else {
                api.setPrefs({
                    key: 'city',
...
function OSS_delete(name){
    api.ajax({
        url: 'http://www.chekehome.com/oss-sdk/samples/Index.php',
        method: 'get',
        data: {
            values: {
                name: name,
...
function isiPhoneX(){
  return api.deviceModel.indexOf("iPhone10")==0;
}/*
    ...
    u.fixIos7Bar = function(el){
        ...
        if (strDM == 'ios') {
            ...
            if (numSV >= 7 && !fullScreen && iOS7StatusBarAppearance) {
                if(api.deviceModel.indexOf("iPhone10")==0){
