...
(function(a, b) {
    ...
    a.prototype.extendDownScroll = function(b) {
        a.extend(b, {
            ...
            showLoading: function(c) {
                ...
                if (c.downProgressDom) {
                    c.downProgressDom.style.transform=transform;
                    var rule,cssRule;
                    ...
                    for (var i = 0; i < ss.length; ++i) {
                        ...
                        for (var x = 0; x < ss[i].cssRules.length; ++x) {
                            ...
                            if (rule.name == "mescrollRotate" && rule.type == CSSRule.KEYFRAMES_RULE) {
                                cssRule = rule;
                            }
                        }
                    }
                    ...
                    cssRule.appendRule("0% { -webkit-transform:rotate(" + transform + "deg)}");
                    cssRule.appendRule("100% { -webkit-transform:rotate(" + (transform+360) + "deg)}");
    ...
    a.prototype.extendUpScroll = function(b) {
        ...
        a.extend(b, {
            ...
            htmlNodata: '<p class="upwarp-nodata">没有更多内容啦~</p>',
            inited: function(d, e) {},
